...
public class AgencyJdbcTemplateRepository implements AgencyRepository {
    ...
    private void addAgents(Agency agency) { //adding an agent, which is all the way over to the right
        ...
        agency.setAgents(agencyAgents); //setting the agent field in agency
    }
