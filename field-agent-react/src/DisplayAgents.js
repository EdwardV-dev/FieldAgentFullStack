    ...
    <div className="agent-list">
      <div className="col">
        {editing ? (
          ...
          <>
           {/* sending in currently selected agent and setDeletion state */}
          ...
          <>
            ...
            <ul>{agents.map((element) => (  //Curly brackets break into javascript
              ...
              <li key={element.agentId}>ID: {element.agentId}, DOB: {element.dob}, Last Name: {element.lastName}
                <button onClick={() => deleteRow(element)}> Delete </button>
